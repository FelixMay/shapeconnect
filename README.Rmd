...
The goal of shapeconnect is to calculate the connectivity index described in 
[May et al. 2013a](http://onlinelibrary.wiley.com/doi/10.1111/j.1600-0587.2012.07793.x/full).

As input the calculation requires a landscape raster with a unique ID
for every habitat fragment. The strength of the index is that it considers
fragment distance, shapes and areas. Therefore, it is well suited for landscapes
with irregular fragment shapes.

See Equations 5 and 6 in May et al. 2013a for a definition of the index and
see [May et al. 2013b](http://www.sciencedirect.com/science/article/pii/S1433831913000590)
for another application example.
